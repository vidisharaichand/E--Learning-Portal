                        ...
                        <div className="contact-information">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span className="text"><span>Bihar ,India</span></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-telephone-outline" /></span>
                                    <span className="text"><a href="tel:8826436647">(+91) 8826436647</a></span>
                                </li>
                                <li>
                                    <span className="icon"><i className="ion-ios-email-outline" /></span>
                                    <span className="text"><a href="mailto:shoaibmalik6647@gmail.com">shoaibmalik6647@gmail.com</a></span>
                                </li>
                            </ul>
                        </div>
                        </div>
